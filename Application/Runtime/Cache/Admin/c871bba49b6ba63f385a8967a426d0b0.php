...
.error-container{ background:#fff; border:1px solid #0ae;  text-align:center; width:450px; margin:200px auto; font-family:Microsoft Yahei; padding-bottom:30px; border-top-left-radius:5px; border-top-right-radius:5px;  }
...
<div class="error-container"> 
    <h1> 后台管理系统-信息提示 </h1>   
    <div class="errorcon">     
        <i class="fa fa-smile-o"></i><?php echo($message); ?>         
        <span style="display:none;"><i class="fa fa-smile-o"></i>操作成功!</span>
