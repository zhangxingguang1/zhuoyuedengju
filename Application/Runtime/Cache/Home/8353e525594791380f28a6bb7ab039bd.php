...
<script>
	...
	<div class="content clears">
		...
		<?php if(is_array($detail)): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news_show_content">
				<h3 class="news_title"><?php echo ($vo["title"]); ?></h3>	
				<span class="news_date">发布时间：<?php echo ($vo["date"]); ?></span>		
				<div class="news_content"><?php echo ($vo["content"]); ?></div>
