...
<script>
	...
	<div class="content clears">
			...
			<?php if($date == null): ?><div class="show clears" id="showtime">
		            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div name="showtime" class="pro_page_num chage_page">
				...
				<div id="barcon"></div>
	        <?php else: ?>
	            <p style="height:400px; width:50%; text-align:center;margin:0 auto;">
					<img src="/zhuoyue/Public/home/images/notfund.gif" style="width:100%;margin-top:40px;" />
	            </p><?php endif; ?>	
	</div>
	<script>
